...
public class Calculo_pago {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El empleado gana un total de: "+empleado1.calcularTotal(2022, 1000, 2000, 3000)+" $");
        ...
        System.out.println("El empleado gana un total de: "+empleado2.calcularTotal(2022, 1000, 2000, 3000)+" $");
        ...
        System.out.println("El empleado gana un total de: "+empleado3.calcularTotal(2022, 1000, 2000, 3000)+" $");
    }
}
